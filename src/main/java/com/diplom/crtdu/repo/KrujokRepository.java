...
public interface KrujokRepository extends CrudRepository<Krujok,Long> {
    ...
    @Query(value = "select krujok.* from krujok where krujok.type_krujok_id = :id and krujok.archive = false order by krujok.creative_association_id",nativeQuery = true)
